...
Lemma dottx `{laws} `{TOP+DOT+ONE ≪ l} n m (x: X n m): x ≦ top⋅x.
Proof. rewrite <-dot1x at 1. apply dot_leq; lattice. Qed.

Lemma dotxt `{laws} `{TOP+DOT+ONE ≪ l} n m (x: X m n): x ≦ x⋅top.
Proof. dual @dottx. Qed.

Lemma top_nnm `{laws} `{TOP+DOT+ONE ≪ l} n m: top' n n ⋅ top' n m ≡ top' n m. 
Proof. apply leq_tx_iff. apply dottx. Qed.

Lemma top_mnn `{laws} `{TOP+DOT+ONE ≪ l} n m: top' m n ⋅ top' n n ≡ top' m n. 
Proof. dual @top_nnm. Qed.

Lemma disjoint_id `{laws} `{AL+BOT+DOT+ONE ≪ l} n m (p q: X n m): p ⊓ q ≦ 0 -> 1 ⊓ (p⋅q°) ≡ 0. 
Proof. 
  intro Hpq. apply leq_xb_iff. rewrite capC, capxdot. ra_normalise.
  rewrite Hpq. ra. 
Qed.

Lemma dedekind `{laws} `{AL+DOT ≪ l} n m p (x : X n m) (y : X m p) (z : X n p):
  x⋅y ⊓ z ≦ (x ⊓ (z⋅y°))⋅(y ⊓ (x°⋅z)).
...
Lemma nonempty_dom `{laws} `{TOP+DOT+ONE ≪ l} n m {x: X n m} {Hx: is_nonempty x}: is_nonempty' n.
Proof. intros i j. rewrite nonempty. mrewrite (leq_xt (x⋅top' _ j)). ra. Qed.

Lemma nonempty_cod `{laws} `{TOP+DOT+ONE ≪ l} n m {x: X n m} {Hx: is_nonempty x}: is_nonempty' m.
Proof. intros i j. rewrite nonempty. mrewrite (leq_xt (top' i _⋅x)). ra. Qed.
...
Global Instance is_transitive_weq {n} `{DOT ≪ l}: Proper (weq ==> iff) (@is_transitive n).
...
Global Instance is_univalent_weq `{DOT+CNV ≪ l} {n m}: Proper (weq ==> iff) (@is_univalent n m).
Proof. intros ? ? E. unfold is_univalent. now rewrite E. Qed.
Global Instance is_injective_weq `{DOT+CNV ≪ l} {n m}: Proper (weq ==> iff) (@is_injective n m).
Proof. intros ? ? E. unfold is_injective. now rewrite E. Qed.
Global Instance is_surjective_weq `{DOT+CNV ≪ l} {n m}: Proper (weq ==> iff) (@is_surjective n m).
Proof. intros ? ? E. unfold is_surjective. now rewrite E. Qed.
Global Instance is_total_weq `{DOT+ONE+CNV ≪ l} {n m}: Proper (weq ==> iff) (@is_total n m).
Proof. intros ? ? E. unfold is_total. now rewrite E. Qed.
Global Instance is_vector_weq {n m} `{DOT ≪ l}: Proper (weq ==> iff) (@is_vector n m).
Proof. intros ? ? E. unfold is_vector. now rewrite E. Qed.
Global Instance is_nonempty_weq {n m} `{DOT ≪ l}: Proper (weq ==> iff) (@is_nonempty X n m).
...
Global Instance is_point_weq `{DOT+CNV ≪ l} {n m}: Proper (weq ==> iff) (@is_point n m).
Proof. apply proper_weq_leq_iff. intros ? ? E [? ? ?]. split; now rewrite <-E. Qed.
Global Instance is_atom_weq `{DOT+CNV ≪ l} {n m}: Proper (weq ==> iff) (@is_atom n m).
Proof. apply proper_weq_leq_iff. intros ? ? E [? ? ?]. split; now rewrite <-E. Qed.
Global Instance is_mapping_weq `{DOT+ONE+CNV ≪ l} {n m}: Proper (weq ==> iff) (@is_mapping n m).
Proof. apply proper_weq_leq_iff. intros ? ? E [? ?]. split; now rewrite <-E. Qed.
Global Instance is_per_weq `{DOT+CNV ≪ l} {n}: Proper (weq ==> iff) (@is_per n).
Proof. apply proper_weq_leq_iff. intros ? ? E [? ?]. split; now rewrite <-E. Qed.
Global Instance is_preorder_weq {n} `{DOT ≪ l}: Proper (weq ==> iff) (@is_preorder n).
Proof. apply proper_weq_leq_iff. intros ? ? E [? ?]. split; now rewrite <-E. Qed.
Global Instance is_order_weq `{AL+DOT ≪ l} {n}: Proper (weq ==> iff) (@is_order n).
Proof. apply proper_weq_leq_iff. intros ? ? E [? ?]. split; now rewrite <-E. Qed.

(** alternative characterisation of [is_surjective] *)

Lemma surjective_tx `{TOP+DOT+ONE ≪ l} {n m} {x: X n m} {Hx: is_surjective x} p: top' p _ ⋅ x ≡ top.
Proof.
  apply leq_tx_iff. transitivity (top' p _ ⋅ (x° ⋅ x)).
  rewrite <-surjective. ra. rewrite dotA. apply dot_leq; lattice.
Qed.

Lemma tx_surjective `{AL+TOP+DOT+ONE ≪ l} n m (x: X m n): top' n n ≦ top⋅x -> is_surjective x.
Proof.
...
Lemma vector' `{DOT+TOP ≪ l} {n m} {v: X n m} {Hv: is_vector v} x: v ⋅ x ≦ v.
Proof. rewrite <-vector at 2. ra. Qed.

Lemma top_nonempty `{DOT+ONE+TOP ≪ l} {n m p} {Hm: is_nonempty' m}: top' n m ⋅ top' m p ≡ top.
Proof. apply leq_tx_iff. rewrite nonempty. ra. Qed.


(** instances for proof search  *)
Global Instance point_surjective `{AL+TOP+DOT+ONE ≪ l} {n m} {p: X n m} {Hp: is_point p}: is_surjective p | 1.
Proof. apply tx_surjective. rewrite nonempty at 1. now mrewrite vector. Qed.

Global Instance atom_injective `{TOP+DOT+ONE ≪ l} {n m} {a: X n m} {Ha: is_atom a}: is_injective a.
Proof. unfold is_injective. rewrite <-a_top_a'. rewrite <-(leq_xt 1). ra. Qed.

Global Instance atom_univalent `{TOP+DOT+ONE ≪ l} {n m} {a: X n m} {Ha: is_atom a}: is_univalent a.
Proof. unfold is_univalent. rewrite <-a'_top_a. rewrite <-(leq_xt 1). ra. Qed.

Global Instance is_symmetric_neg1 `{BL+DOT+ONE+CNV ≪ l} {n}: is_symmetric (!one n).
Proof. unfold is_symmetric. rewrite <-dotx1. apply Schroeder_. rewrite negneg. ra. Qed.

Global Instance irreflexive_cnv `{AL+BOT+DOT+ONE ≪ l} {n} {x: X n n} {Hx: is_irreflexive x}: is_irreflexive (x°).
Proof. unfold is_irreflexive. cnv_switch. now ra_normalise. Qed.

Global Instance reflexive_cnv `{DOT+ONE+CNV ≪ l} {n} {x: X n n} {Hx: is_reflexive x}: is_reflexive (x°).
Proof. unfold is_reflexive. cnv_switch. now ra_normalise. Qed.

Global Instance transitive_cnv `{DOT+CNV ≪ l} {n} {x: X n n} {Hx: is_transitive x}: is_transitive (x°).
Proof. unfold is_transitive. cnv_switch. now ra_normalise. Qed.

Global Instance symmetric_cnv `{DOT+CNV ≪ l} {n} {x: X n n} {Hx: is_symmetric x}: is_symmetric (x°).
...
Global Instance injective_cnv `{DOT+CNV ≪ l} {n m} {x: X n m} {Hx: is_univalent x}: is_injective (x°).
Proof. unfold is_injective. now rewrite cnv_invol. Qed.

Global Instance univalent_cnv `{DOT+CNV ≪ l} {n m} {x: X n m} {Hx: is_injective x}: is_univalent (x°).
Proof. unfold is_univalent. now rewrite cnv_invol. Qed.

Global Instance surjective_cnv `{DOT+CNV ≪ l} {n m} {x: X n m} {Hx: is_total x}: is_surjective (x°).
Proof. unfold is_surjective. now rewrite cnv_invol. Qed.

Global Instance total_cnv `{DOT+CNV ≪ l} {n m} {x: X n m} {Hx: is_surjective x}: is_total (x°).
Proof. unfold is_total. now rewrite cnv_invol. Qed.

Global Instance preorder_cnv `{DOT+ONE+CNV ≪ l} {n} {x: X n n} {Hx: is_preorder x}: is_preorder (x°).
Proof. constructor; tc. Qed.

Global Instance nonempty_cnv `{DOT+CNV+TOP ≪ l} {n m} {x: X n m} {Hx: is_nonempty x}: is_nonempty (x°).
Proof. intros i j. cnv_switch. ra_normalise. apply Hx. Qed.

Global Instance atom_cnv `{DOT+CNV+TOP ≪ l} {n m} {x: X n m} {Hx: is_atom x}: is_atom (x°).
Proof.
  split.
...
Global Instance mapping_cnv `{AL+TOP+DOT+ONE ≪ l} {n m} {x: X n m} {Hx: is_point x}: is_mapping (x°).
Proof. split; tc. Qed.          (* actually just need x to be injective and surjective *)

Global Instance order_cnv `{AL+DOT+ONE ≪ l} {n} {x: X n n} {Hx: is_order x}: is_order (x°).
Proof. constructor; tc. Qed.

Global Instance vector_cap `{CAP+TOP+DOT+ONE ≪ l} {n m} {v w: X n m} {Hv: is_vector v} {Hw: is_vector w}: is_vector (v ⊓ w). 
Proof. 
  unfold is_vector. apply antisym. 2: apply dotxt. 
  now rewrite dotcapx, 2vector. 
Qed.   

Global Instance preorder_str `{DOT+ONE+STR ≪ l} n (x: X n n): is_preorder (x^*).
Proof. split. apply str_refl. apply weq_leq, str_trans. Qed.

Global Instance symmetric_str `{DOT+ONE+STR+CNV ≪ l} {n} {x: X n n} {Hx: is_symmetric x}: is_symmetric (x^*).
Proof. unfold is_symmetric. now rewrite cnvstr, symmetric. Qed.

Global Instance reflexive_itr `{DOT+ONE+STR+CNV ≪ l} {n} {x: X n n} {Hx: is_reflexive x}: is_reflexive (x^+).
Proof. unfold is_reflexive. rewrite reflexive. apply itr_ext. Qed.

Global Instance transitive_itr `{DOT+ONE+STR ≪ l} n (x: X n n): is_transitive (x^+).
Proof. apply itr_trans. Qed.

Global Instance symmetric_itr `{DOT+ONE+STR+CNV ≪ l} {n} {x: X n n} {Hx: is_symmetric x}: is_symmetric (x^+).
Proof. unfold is_symmetric. now rewrite cnvitr, symmetric. Qed.


(** lemmas about relations of a specific shape *)

Lemma itr_transitive `{DOT+ONE+STR ≪ l} n (x: X n n): is_transitive x -> x^+ ≡ x.
...
Lemma dot_mono `{AL+DOT+ONE ≪ l} n (x y: X n n): x ≦ 1 -> y ≦ 1 -> x⋅y ≡ x ⊓ y. 
Proof. 
...
Lemma kernel_refl_antisym `{laws} `{CAP+DOT+ONE+CNV ≪ l} {n} {x: X n n}
...
Lemma dot_univalent_cap `{AL+DOT+ONE ≪ l} {n m p} {x: X n m} {y z: X m p}
  {E: is_univalent x}: x ⋅ (y ∩ z) ≡ (x⋅y) ∩ (x⋅z).  
Proof. apply antisym. ra. rewrite capdotx. mrewrite univalent. ra. Qed.

Lemma univalent_antisym `{AL+TOP+DOT+ONE ≪ l} {n m} {x y: X n m}
...
Lemma surjective_injective_antisym `{AL+TOP+DOT+ONE ≪ l} {n m} {p q: X n m}
...
Lemma disjoint_vect_iff `{BL+DOT+CNV ≪ l} {n m} {p q: X n m}
...
Lemma disjoint_vect_iff' `{AL+DOT+DIV+BOT+TOP ≪ l} {n m} {p q: X n m}
  {Hq: is_vector q}: p ⊓ q ≦ 0 <-> q°⋅p ≦ 0.
Proof.
  split; intro Hpq.
...
Lemma gen_point {Hl: DOT+ONE+CNV+TOP ≪ l} n m k (p: X n m):
...
Lemma leq_xyp `{AL+TOP+DOT+ONE ≪ l} {n m k} {p: X m k} {x: X n k} {y: X n m}
...
Lemma leq_pxq `{AL+TOP+DOT+ONE ≪ l} {n m k} {p: X n k} {q: X m k} {x: X n m}
   {Hp: is_point p} {Hq: is_point q}: p ≦ x⋅q <-> q ≦x°⋅p.
Proof. rewrite 2leq_xyp. now rewrite cnv_leq_iff', cnvdot, cnv_invol. Qed.

Lemma point_lattice_atom {Hl: AL+TOP+DOT+ONE ≪ l} {n m} {p v: X n m} {Hp: is_point p} {Hv: is_vector v}:
...
Lemma dot_neg_inj {Hl: BL+DOT+ONE+CNV ≪ l} {n m p} {x: X n m} {y: X m p} {Hy: is_injective y}: !x ⋅ y ≦ !(x⋅y).
Proof. rewrite Schroeder_r, 2negneg. mrewrite injective. ra. Qed.

Lemma dot_neg_surj {Hl: BL+DOT+ONE+CNV ≪ l} {n m p} {x: X n m} {y: X m p} {Hy: is_surjective y}: !(x⋅y) ≦ !x ⋅ y.
Proof.
  rewrite leq_cap_neg. rewrite <-negcup, <-dotplsx, cupneg. now rewrite surjective_tx, negtop.
Qed.

Lemma dot_neg_point {Hl: BL+DOT+ONE+CNV ≪ l} {n m k} {x: X n m} {p: X m k} {Hp: is_point p}: !x ⋅ p ≡ !(x⋅p).
Proof. apply antisym. apply dot_neg_inj. apply dot_neg_surj. Qed.

Lemma disjoint_vect_ext {Hl: BL+DOT+ONE+CNV ≪ l} {n m k} {x y: X n m} {x' y': X m k}
...
Lemma atom_of_points_aux `{AL+TOP+DOT+ONE ≪ l} {n m k} {p: X n m} {q: X k m} {Hp: is_point p} {Hq: is_point q}:
  p ⋅ q° ⋅ top ⋅ q ⋅ p° ≦ 1.
Proof.
...
Lemma atom_of_points `{AL+TOP+DOT+ONE ≪ l} {n m k} {p: X n m} {q: X k m} {Hp: is_point p} {Hq: is_point q}:
  is_atom (p⋅q°).
Proof.
...
Lemma point_a_top `{CNV+TOP+DOT+ONE ≪ l} {n m} {a: X n m} {Ha: is_atom a}: is_point (a⋅top' m m).
Proof.
  split.
...
Lemma point_a'_top `{DOT+ONE+CNV+TOP ≪ l} {n m} {a: X n m} {Ha: is_atom a}: is_point (a°⋅top' n n).
Proof. apply point_a_top. Qed.

Lemma a_top_a_aux `{AL+DOT+ONE+TOP ≪ l} {n m} {a: X n m} {Ha: is_atom a}: (a ⋅ top) ∩ (top ⋅ a) ≡ a.
Proof.
  apply antisym.
...
Lemma a_top_a `{AL+DOT+ONE+TOP ≪ l} {n m} {a: X n m} {Ha: is_atom a}: a ⋅ top ⋅ a ≡ a.
Proof.
...
Global Instance atom_transitive `{AL+DOT+ONE+TOP ≪ l} {n} {a: X n n} {Ha: is_atom a}: is_transitive a.
Proof. unfold is_transitive. rewrite <-a_top_a at 3. rewrite <-(leq_xt 1). ra. Qed.

(* TOTHINK: transitivity should follow from mono *)
Lemma atom_mono `{AL+DOT+ONE+TOP ≪ l} {n} {a: X n n} {Ha: is_atom a}: a⋅a ≦ 1.
Proof.
...
Lemma atom_points `{AL+DOT+ONE+TOP ≪ l} {n m k} {a: X n m} {Ha: is_atom a} {Hk: is_nonempty' k}:
...
Lemma atom_lattice_atom {Hl: AL+DOT+ONE+TOP ≪ l} {n m} {a x: X n m} {Ha: is_atom a}:
...
Lemma total_xt `{laws} `{DOT+ONE+TOP ≪ l} {n m} {x: X n m} {Hx: is_total x} p: x⋅top' _ p ≡ top.
Proof. now dual @surjective_tx. Qed.

Lemma xt_total `{laws} `{AL+DOT+ONE+TOP ≪ l} n m (x: X n m): top' n n ≦ x⋅top -> is_total x.
Proof. now dual @tx_surjective. Qed.

Lemma dot_cap_injective `{laws} `{AL+DOT+ONE ≪ l} {n m p} {x: X m n} {y z: X p m}
